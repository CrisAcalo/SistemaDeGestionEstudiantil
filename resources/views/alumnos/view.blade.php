                        ...
                        <div class="col-md-6">
                            <div class="card">
                                @if ($alumno->foto_estudiante != null)
                                    <img class="card-img-top imgs" src="/fotosAlumnos/{{ $alumno->foto_estudiante }}"
                                        alt="Foto-Alumno" style="width:200px; margin: 0 auto;">
                                @else
                                    <img class="card-img-top imgs" src="{{ asset('images/users.png') }}" alt="Foto-Alumno"
                                        style="width:200px; margin: 0 auto;">
                                @endif

                                <div class="card-body">
                                    <h6 class="card-title"><strong>Nombre y Apellido:</strong>
                                        {{ $alumno->nameFullAlumno }}
                                        <hr>
                                    </h6>
                                ...
                                <div class="list-group">
                                    ...
                                    @foreach ($pagosCursoAlumno as $pago)
                                        <p class="list-group-item list-group-item-action"
                                            ...
                                            <span>
                                                <a href="/fotosPagos/{{ $pago->photo_pago }}" class="btn btn-info"
                                                    target="_blank">ver recibo</a>
                                            </span>
                                        </p>
                                    @endforeach
                                </div>
