        ...
        <ul class="nav">
            ...
            {{-- <li class="nav-item">
                ...
                <div class="collapse" id="ui-basic">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="{{ route('alumno.create') }}">Registrar nuevo
                                Alumno</a></li>
                        <li class="nav-item"> <a class="nav-link" href="{{ route('alumno.index') }}">Lista de
                                Alumnos</a></li>
                    </ul>
                </div>
            </li> --}}
            ...
            {{-- <li class="nav-item">
                ...
                <div class="collapse" id="auth">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="{{ route('pago.create') }}">Registrar nuevo
                                Pago</a></li>
                        <li class="nav-item"> <a class="nav-link" href="{{ route('pago.index') }}">Lista de Pagos</a>
                        </li>
                    </ul>
                </div>
            </li> --}}
